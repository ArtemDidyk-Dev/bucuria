...
@if ($showmore && isset($pagination['arrow_right']))
    <div class="show-more-wrapper btn-pagination" onclick="make_pagination(this, true); return false;">
        ...
        <x-inputs.button type="empty center catalog" :href="$pagination['link'] . $pagination['separator'] . 'page=' . $pagination['arrow_right']">
            {{ $fields['showmore'] }}
        </x-inputs.button>
    </div>
@endif
...
<div class="pagination-wrapper mb-100">
    <div class="container">
        <div class="pagination">
            ...
            <div class="pagination-btn-wrapper pagination-btn-wrapper-arrow"
                onclick="make_pagination(this); return false;">
                <a href="<?php echo $pagination['link']; ?><?php echo $pagination['arrow_left'] != 1 ? $pagination['separator'] . 'page=' . $pagination['arrow_left'] : ''; ?>" class="pagination-btn">
                    <svg class="pagination-arrow-left" width="12" height="12" viewBox="0 0 12 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M2.90292 5.67074L8.44405 0.129616C8.62749 -0.0475487 8.91981 -0.0424621 9.09697 0.140979C9.26981 0.31993 9.26981 0.603615 9.09697 0.782538L3.88231 5.9972L9.09697 11.2119C9.27725 11.3922 9.27725 11.6845 9.09697 11.8648C8.91664 12.0451 8.62435 12.0451 8.44405 11.8648L2.90292 6.32366C2.72265 6.14333 2.72265 5.85105 2.90292 5.67074Z"
                            fill="#333333" />
            ...
            <?php endif; ?>
            <div class="pagination-btn-wrapper" onclick="make_pagination(this); return false;">
                <a href="<?php echo $pagination['link']; ?>" class="pagination-btn<?php if ($pagination['active'] == 1) {
                    echo ' active';
                } ?>">
                    1
                </a>
            ...
            <?php else: ?>
            <div class="pagination-btn-wrapper" onclick="make_pagination(this); return false;">
                <a href="<?php echo $pagination['link']; ?><?php echo $pagination['separator']; ?>page=<?php echo $item; ?>"
                    class="pagination-btn<?php if ($pagination['active'] == $item) {
                        echo ' active';
                    } ?>">
                    <?php echo $item; ?>
                </a>
            ...
            <?php endif; ?>
            <div class="pagination-btn-wrapper" onclick="make_pagination(this); return false;">
                <a href="<?php echo $pagination['link']; ?><?php echo $pagination['separator']; ?>page=<?php echo $pagination['last']; ?>"
                    class="pagination-btn<?php if ($pagination['active'] == $pagination['last']) {
                        echo ' active';
                    } ?>">
            ...
            <div class="pagination-btn-wrapper pagination-btn-wrapper-arrow"
                ...
                <a href="<?php echo $pagination['link']; ?><?php echo $pagination['separator']; ?>page=<?php echo $pagination['arrow_right']; ?>" class="pagination-btn">
                    <svg class="pagination-arrow-right" width="12" height="12" viewBox="0 0 12 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M9.09708 5.67074L3.55595 0.129616C3.37251 -0.0475487 3.08019 -0.0424621 2.90303 0.140979C2.73019 0.31993 2.73019 0.603615 2.90303 0.782538L8.11769 5.9972L2.90303 11.2119C2.72275 11.3922 2.72275 11.6845 2.90303 11.8648C3.08336 12.0451 3.37565 12.0451 3.55595 11.8648L9.09708 6.32366C9.27735 6.14333 9.27735 5.85105 9.09708 5.67074Z"
                            fill="#333333" />
...
<style>
    ...
    .pagination-btn path {
        fill: var(--color-red);
        box-shadow: 0vw 0vw 0.4167vw 2px rgba(0, 0, 0, 0.06);
        border-radius: 100px;
        transition: .3s;
    }
    ...
    .pagination-btn-wrapper-arrow .pagination-btn {
        box-shadow: 0vw 0vw 0.4167vw 2px rgba(0, 0, 0, 0.06);
    }
</style>
