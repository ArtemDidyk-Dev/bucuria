...
<div class="modal modal-loyalty fade-in" id="modal-loyalty-success">
    <div class="container-modal container-modal-loyalty">
        ...
        <div class="main-text color-black membership-modal-text">
            {!! Field::enter_to_br($s->field('Программа лояльности', 'Успешно', 'textarea', true, 'You have successfully registered in our loyalty program.')) !!}
        </div>
    </div>
</div>